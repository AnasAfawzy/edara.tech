  ...
  _unbindMenuMouseEvents() {
    ...
    if (this._menuMouseEnter) {
      if (layoutMenu) {
        ...
        layoutMenu.removeEventListener('touchstart', this._menuMouseEnter, { passive: true })
      }
    ...
    if (this._windowTouchStart) {
      if (layoutMenu) {
        window.addEventListener('touchstart', this._windowTouchStart, { capture: true, passive: true })
      }
