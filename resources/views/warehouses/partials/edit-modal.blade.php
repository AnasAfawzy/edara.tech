                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12 mb-3">
                            <label for="edit-warehouse-name" class="form-label">{{ __('Warehouse Name') }} <span class="text-danger">*</span></label>
                            <input type="text"
                                   class="form-control"
                        ...
                        <div class="col-12 mb-3">
                            <label for="edit-status" class="form-label">{{ __('Status') }} <span class="text-danger">*</span></label>
